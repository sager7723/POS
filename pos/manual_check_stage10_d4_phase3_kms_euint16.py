...
os.environ["POS_FHE_WORD_BITS"] = "16"
...
def main() -> None:
    ...
    print("=== Stage-10-D4 Phase3 strict KMS euint16 candidate messages ===")
    ...
    for participant_id, message in phase3.candidate_messages.items():
        ...
        assert stake_payload["data_type"] == "euint16"
        assert prf_payload["data_type"] == "euint16"
    ...
    print("\\nStage-10-D4 Phase3 strict KMS euint16 check passed.")
